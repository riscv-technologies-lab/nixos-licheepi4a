# `nixos/modules/installer/sd-card/sd-image.nix` patched for Lichee Pi 4A
#
      ...
      stdenv.mkDerivation {
        ...
        buildCommand = ''
          ...
          sfdisk $img <<EOF
              ...
              start=''${gap}M, size=$firmwareSizeBlocks, type=EBD0A0A2-B9E5-4433-87C0-68B6B72699C7, bootable
              start=$((gap + ${toString config.sdImage.firmwareSize}))M, type=0FC63DAF-8483-4772-8E79-3D69D8477DE4
          EOF
